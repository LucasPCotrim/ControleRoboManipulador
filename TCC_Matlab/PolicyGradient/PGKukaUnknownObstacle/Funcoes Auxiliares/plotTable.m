function plotTable()
    ...
    % Uknown Obstacle (Wall)
    x_u_obs_plot = xtable_orig;
    y_u_obs_plot = y_u_obs - 0.5*width_u_obs;
    z_u_obs_plot = table_height;
    cube_plot([x_u_obs_plot y_u_obs_plot z_u_obs_plot], table_width, width_u_obs, height_u_obs, [0.7 0.7 0.6])
end
