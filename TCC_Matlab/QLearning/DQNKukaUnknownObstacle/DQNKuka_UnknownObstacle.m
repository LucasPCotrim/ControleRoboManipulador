%% Deep Q Network Kuka (DQNkuka) - Deep Q-learning Kuka Robot Arm 5R (5DoF) %%
%----------------------------------------------------------------------------%
clear all;
close all;
clc;
...
epsilonDecay = 0.996; % Decay factor per iteration.
...
global epochBuffer;
epochBuffer = epochs(maxEpoch,Ntrajs);
...
%     if(rem(ep_index,10) == 0 || ep_index == 1)
